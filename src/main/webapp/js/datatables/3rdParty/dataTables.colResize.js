    ...
    var factory = function ($, DataTable) {
        ...
        ColResize.prototype = {
            ...
            "_fnMouseMove": function (e) {
                ...
                //MODIFIED FOR EPL
                $(that.s.dt.oInstance).trigger('column-resize', [
                    that.s.dt, {
                    "iCol": that.s.mouse.targetColumn.idx
                } ]);
            },
            ...
            "_fnResizeHandleCheck": function (e, nTh) {
	            ...
	            if (!that.s.isMousedown) {//MODIFIED FOR EPL - fix when check is replacing resizing column while resizing another column
